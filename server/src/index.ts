...
server.registerTool(
  "load-preset",
  {
    ...
    description:
      ...
      "premium (AI Premium Features). Returns pre-filled inputs you can pass to calculate-roi-v2.",
    inputSchema: {
      preset: z
      ...
      content: [
        {
          ...
          text: [
            ...
            "",
            "You can now run `calculate-roi-v2` with these defaults, or modify individual fields.",
          ].join("\n"),
        },
      ],
      isError: false,
